...
int dice(int odds) {
    ...
    1. Gaining renown and becoming dragon ruler
...
int main() {
    ...
    while (hp > 0) { 
        ...
        // Last situation and challenge:
        std::cout << "You finally find " << name << "'s siblings, but they seem ready to strike.\n" <<
        "They are fully grown now and their power is immense. How do you respond?\n\n";

        std::cout << "   1) Stand tall and show them you will not back down.\n";
        std::cout << "   2) Take a seat and show you and " << name << " mean no harm.\n";
        std::cout << "   3) Strike first and hold nothing back.\n";

        std::cin >> answer;

        
        // Need a dice roll higher than 80% of dice size for move to be successful, result = 1
        // Otherwise, result = 0 and user must try again, but loses hp points
        while (result == 0) {
        ...
        int max = 0;
        std::string winner;
        std::string ending_pt1;
        std::string ending_pt2;
    

        if (ruler > max) {
            max = ruler;
            winner = "Ruler";
            ending_pt1 = "They attacked, but you established yourself as superior, without killing them, thus earning their respect.\n";
            ending_pt2 = "You have proven to be a righteous leader. The people of the land have chosen you to lead them.\n";
        }

        if (sage > max) {
            max = sage;
            winner = "Sage";
            ending_pt1 = "The siblings soon calmed down and you approached.\nYou were able to communicate with them and create a wonderful reunion.\n";
            ending_pt2 = "You have proven to be a wise and peaceful soul. The elders grant you their highest honor among the clan.\n";
        } 

        if (slayer > max) {
            max = slayer;
            winner = "Slayer";
            ending_pt1 = "They attacked and there was no room for holding back. You were forced to put the siblings down. \n";
            ending_pt2 = "You have proven to be the most feared warrior. Children will be told of your legend as a warning to never incur your wrath.\n";
        }
        std::cout << ending_pt1 << "\n";
