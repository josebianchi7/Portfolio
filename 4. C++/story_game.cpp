...
int main() {
    ...
    while (hp > 0) { 
        ...
        std::cout << "You finally find " << name << "'s siblings, but they seem ready to fight.\n" <<
        ...
        switch (answer) {
            case 1: 
                king += 1;
                std::cout << "You and " << name << " had to fight, but once the siblings realized you kept backing up on opportunities to kill, " << 
                "they understood your intentions and became friendly.\n\n";
                break;
            case 2: 
                sage += 1;
                std::cout << "The siblings kept roaring and preparing to attack, but you did not budge. They soon calmed down and you approached. " <<
                "You were able to communicate with them and create a wonderful reunion.\n\n";
                break;
            case 3: 
                slayer += 1;
                std::cout << name << " followed your lead and without hesitation attacked its siblings. It was the toughest battle yet, " <<
                "but not even dragons could defeat you two.\n\n";
                break;
            default:
                std::cout << "Invalid response. Moving on.\n";
                break;  
